...
% Ce gain de subdivision est défini par la formule suivante : 
...
Nous utilisons la procédure de recherche aléatoire pour trouver la meilleure combinaison d'hyperparamètres. Celle-ci est choisie en prenant la combinaison ayant la meilleure moyenne du score F1. Nous priorisons cette procédure plutôt qu'une recherche en grille par soucis computationnel. 
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        Complément de Bayes naïf &  &  &  &  &  & x & 0.5581\\
        Complément de Bayes naïf &  &  &  &  &  &  & 0.5814\\
        Complément de Bayes naïf &  &  & x &  & x & x & 0.5640\\
        Complément de Bayes naïf & x &  & x &  & x & x & 0.6450\\
        Complément de Bayes naïf &  & x &  & x & x &  & 0.6450\\
        Classifier SVM &  & x &  & x & x &  & 0.6510\\
        Classifier SGD avec Huber modifié &  & x &  & x & x &  & 0.6107\\
        Classifieur XGBoost &  & x &  & x & x &  & 0.6457\\
        Ensembles (CNB, XGBoost, LogReg) &  & x &  & x & x &  & 0.6819\\
        Ensembles (CNB, XGBoost, LogReg) &  & x &  &  & x &  & 0.6785\\
        Ensembles (CNB, XGBoost, SVC, SGD) &  & x &  & x & x &  & 0.6895\\
        \hline
    \end{tabular}
