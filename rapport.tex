...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        \hline
        \textbf{Model} & \textbf{SMOTE} & \textbf{Tree} & \textbf{Stopwords} &
        \textbf{Cumulative Sum} & \textbf{Sous-échant.} & \textbf{Sur-échant.} &
        
        \textbf{Result} \\
        \hline
        Model 1 & x & PCA & SMOTE & 0.85 & PCA & SMOTE & 0.85 \\
        Model 2 & Normalization & None & SMOTE & 0.78 & PCA & SMOTE & 0.85\\
        Model 3 & Standardization & LDA & None & 0.82 & PCA & SMOTE & 0.85\\
        Model 4 & Normalization & PCA & Oversampling & 0.80 & PCA & SMOTE & 0.85\\
        Model 4 & Normalization & PCA & Oversampling & 0.80 & PCA & SMOTE & 0.85\\
        Model 4 & Normalization & PCA & Oversampling & 0.80 & PCA & SMOTE & 0.85\\
        Model 4 & Normalization & PCA & Oversampling & 0.80 & PCA & SMOTE & 0.85\\
        Model 4 & Normalization & PCA & Oversampling & 0.80 & PCA & SMOTE & 0.85\\
