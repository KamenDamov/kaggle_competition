...
if __name__ == "__main__":
    ...
    model_names = ['ComplementNB', 'XGBoost','LogisticRegression'] #, 'SVC', 'LogisticRegression', 'MultinomialNB' 
    ...
    save_output(predictions_voter, "ensemble_cnb_xgboost_logreg", "random_search_5_iter", "stopwords_undersampled")
